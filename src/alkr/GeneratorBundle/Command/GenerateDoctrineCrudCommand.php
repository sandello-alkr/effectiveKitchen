...
namespace alkr\GeneratorBundle\Command;
...
use alkr\GeneratorBundle\Generator\DoctrineCrudGenerator;
...
EOT
            ...
            ->setName('doctrine:generate:rest:crud')
            ->setAliases(array('generate:doctrine:rest:crud'))
        ;
    }
    ...
    {
        $questionHelper = $this->getQuestionHelper();
        $questionHelper->writeSection($output, 'Welcome to the Doctrine2 alkr CRUD generator');
